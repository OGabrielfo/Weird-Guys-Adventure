...
public class TrunkController : MonoBehaviour
{
    ...
    void Fire()
    {
        ...
        if (selfDirection.x < 0)
        {
            bullet = Instantiate(bulletPrefab, firePoint.position, Quaternion.Euler(0f, 0f, 0f));
        }
        else
        {
            bullet = Instantiate(bulletPrefab, firePoint.position, Quaternion.Euler(0f, 180f, 0f));
        }
